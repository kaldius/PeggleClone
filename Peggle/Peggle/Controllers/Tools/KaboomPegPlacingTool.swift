/**
 The `KaboomPegPlacingTool` represents the tool in the level designer that allows the user
 to put down a kaboom peg.
 */

import CoreGraphics
import UIKit

struct KaboomPegPlacingTool: GameObjectPlacingTool {
    ...
    static func == (lhs: KaboomPegPlacingTool, rhs: KaboomPegPlacingTool) -> Bool {
